...
![ResourcesMonitorPy interface](imgs/gui.png)

![ResourcesMonitorPy LLM Analysis](imgs/llm_analysis.png)
...
The collector runs natively on the host (it needs `psutil`, `ps`, and `sudo powermetrics`), while MySQL and the
